...
static struct proc_ops asus_ex_proc_glove_ops = {
	.proc_write = asus_ex_proc_glove_write,
	.proc_read  = asus_ex_proc_glove_read,
};

static struct proc_ops asus_ex_proc_fpxy_ops = {
	.proc_read  = asus_ex_proc_fpxy_read,
};
