...
struct snt8100fsr {
	...
	*/
	...
	int fw_failed_count;
	int fpc_vendor_flag;
	int payload_count; //add payload count to check recieved fw data from service due to GKI
	bool service_load_fw_status;
	int count_2v8;
};
...
struct grip_status {
	...
	int G_SQUEEZE_BARA_UP_RATE[2];
	int G_SQUEEZE_BARA_UP_RATE_ACC[2];
	int G_SQUEEZE_BARA_DROP_RATE[2];
	int G_SQUEEZE_BARA_DROP_RATE_ACC[2];
	int G_SQUEEZE_BARB_UP_RATE[2];
	int G_SQUEEZE_BARB_UP_RATE_ACC[2];
	int G_SQUEEZE_BARB_DROP_RATE[2];
	int G_SQUEEZE_BARB_DROP_RATE_ACC[2];
	int G_TAP_EN[4];
	int G_TAP_FORCE[4];
	int G_TAP_VIB_EN[4];
	int G_TAP_VIB_REPEAT_EN[4];
	int G_TAP_VIB_REPEAT_DUR[4]; //duration
	int G_TAP_REST_EN[4];
	int G_TAP_MIN_POS[4];
	int G_TAP_MAX_POS[4];
