 ...
 */
#if defined CONFIG_TMD2755_FLAG
...
#define PROXIMITY_PTH_MAX		(16383)
/* AMS proximity autok will change adc value, since autok need time, wait for ams chip */
#define PROXIMITY_CALIBRATION_DELAY		(150)
#define LIGHT_TURNON_DELAY_TIME			(150)
#else
#define PROXIMITY_POCKET_MODE_RATIO		(100)
#define PROXIMITY_POCKET_MODE_OFFSET_RATIO		(100)
#define PROXIMITY_ADC_PER_OFFSET (1)
#define PROXIMITY_PTH_MAX		(4095)
 ...
 */
#define LIGHT_LOG_ULTRA_HIGH_LUX_THRESHOLD					(500)
#define LIGHT_LOG_HIGH_LUX_THRESHOLD					(200)
#define LIGHT_LOG_NORMAL_LUX_THRESHOLD					(100)
#define LIGHT_LOG_LOW_LUX_THRESHOLD					(20)
#define LIGHT_LOG_ULTRA_LOW_LUX_THRESHOLD					(5)
...
#ifdef ONE_PL_CHIP
#define PROXIMITY_INF_ER_DEFAULT     (88)
#define PROXIMITY_THDL_ER_DEFAULT    (142)
#define PROXIMITY_THDH_ER_DEFAULT    (225)
#define PROXIMITY_POCKET_ER_DEFAULT       (936)
#ifdef CONFIG_TMD2755_FLAG
#define PROXIMITY_POCKET_DEFAULT       (3800)
#else
#define PROXIMITY_POCKET_DEFAULT       (936)
#endif
