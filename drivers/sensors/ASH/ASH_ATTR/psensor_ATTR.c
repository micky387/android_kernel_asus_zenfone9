...
static ssize_t  ATT_proximity_store_load_pocket_calibration_data(struct device *dev, 
	struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned long load_calibration_data;	

	if(g_psensor_ATTR->ATTR_Extension->proximity_store_load_pocket_calibration_data== NULL) {
		err("proximity_store_load_pocket_calibration_data NOT SUPPORT. \n");
		return count;
	}
	...
	log("Proximity store load_pocket_calibration_data: %lu\n", load_calibration_data);
	
	g_psensor_ATTR->ATTR_Extension->proximity_store_load_pocket_calibration_data(load_calibration_data);
	
	return count;
}

static ssize_t  ATT_proximity_store_load_near_calibration_data(struct device *dev, 
	struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned long load_calibration_data;	

	if(g_psensor_ATTR->ATTR_Extension->proximity_store_load_near_calibration_data== NULL) {
		err("proximity_store_load_near_calibration_data NOT SUPPORT. \n");
		return count;
	}
	...
	log("Proximity store load_near_calibration_data: %lu\n", load_calibration_data);
	
	g_psensor_ATTR->ATTR_Extension->proximity_store_load_near_calibration_data(load_calibration_data);
	
	return count;
}
static ssize_t  ATT_proximity_store_load_far_calibration_data(struct device *dev, 
	struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned long load_calibration_data;	

	if(g_psensor_ATTR->ATTR_Extension->proximity_store_load_far_calibration_data== NULL) {
		err("proximity_store_load_far_calibration_data NOT SUPPORT. \n");
		return count;
	}
	...
	log("Proximity store load_far_calibration_data: %lu\n", load_calibration_data);
	
	g_psensor_ATTR->ATTR_Extension->proximity_store_load_far_calibration_data(load_calibration_data);
	
	return count;
}
static ssize_t  ATT_proximity_store_load_inf_calibration_data(struct device *dev, 
	struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned long load_calibration_data;	

	if(g_psensor_ATTR->ATTR_Extension->proximity_store_load_inf_calibration_data== NULL) {
		err("proximity_store_load_inf_calibration_data NOT SUPPORT. \n");
		return count;
	}
	...
	log("Proximity store load_inf_calibration_data: %lu\n", load_calibration_data);
	
	g_psensor_ATTR->ATTR_Extension->proximity_store_load_inf_calibration_data(load_calibration_data);
...
static struct device_attribute proximity_property_attrs[] = {
	...
	__ATTR(load_pocket_cal, 0220, NULL, ATT_proximity_store_load_pocket_calibration_data),
	__ATTR(load_near_cal, 0220, NULL, ATT_proximity_store_load_near_calibration_data),
	__ATTR(load_far_cal, 0220, NULL, ATT_proximity_store_load_far_calibration_data),
	__ATTR(load_inf_cal, 0220, NULL, ATT_proximity_store_load_inf_calibration_data),
