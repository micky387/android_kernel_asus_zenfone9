...
typedef struct{
	...
	void (*proximity_store_load_pocket_calibration_data)(int value);
	void (*proximity_store_load_near_calibration_data)(int value);
	void (*proximity_store_load_far_calibration_data)(int value);
	void (*proximity_store_load_inf_calibration_data)(int value);
...
extern int psensor_ATTR_register_2nd(psensor_ATTR *mATTR);

/**
 * psensor_ATTR_unregister - remove the psensor attributes.
 */
extern int psensor_ATTR_unregister(void);
extern int psensor_ATTR_unregister_2nd(void);
...
extern int lsensor_ATTR_register_2nd(lsensor_ATTR *mATTR);

/**
 *lsensor_ATTR_unregister - remove the lsensor attributes.
 */
extern int lsensor_ATTR_unregister(void);
extern int lsensor_ATTR_unregister_2nd(void);
...
extern int lsensor_ATTR_create_2nd(struct device_attribute *mlsensor_attr);
 ...
 */
extern bool psensor_factory_write_high(int calvalue, const char *str);
extern bool psensor_factory_write_low(int calvalue, const char *str);
...
extern int ALSPSsensor_gpio_register_2nd(struct i2c_client *client, ALSPSsensor_GPIO *gpio_ist);

/**
 * ALSPSsensor_gpio_unregister - unregister the GPIO setting.
 */
extern int ALSPSsensor_gpio_unregister(int irq);
extern int ALSPSsensor_gpio_unregister_2nd(int irq);
...
extern int ALSPS_i2c_register_2nd(ALSPS_I2C *ir_i2c);
/**
 * ALSPS_i2c_unregister - i2c_del_driver.
 */
extern int ALSPS_i2c_unregister(void);
extern int ALSPS_i2c_unregister_2nd(void);
...
typedef struct ALSPS_status{
	bool probe_status;
	bool als_log_first_evt;
	bool als_skip_polling_first_event;
	bool in_suspend; //show the status of system
}ALSPS_status;
...
extern ALSPS_hw* ALSPS_hw_getHardware_2nd(void);
 ...
 */
#define PROXIMITY_AUTOK_COUNT				(5)
#define PROXIMITY_AUTOK_POLLING			(500)
#define PROXIMITY_AUTOK_DELAY				(11)
#define PROXIMITY_NOISE_AUTOK_COUNT				(3)
#define PROXIMITY_NOISE_AUTOK_DELAY				(20)
